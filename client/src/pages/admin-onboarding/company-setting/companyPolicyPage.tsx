...
const CompanyPolicyPage = () => {
    ...
    const handleEdit = (policy: PolicyWithId) => {
        ...
        setValue("effectiveFrom", policy.effectiveFrom?.split("T")[0]);
                ...
                <div className="space-y-2">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                            ...
                            <Select value={categoryValue} onValueChange={(value) => setValue("category", value as "HR" | "Finance" | "IT" | "Security" | "Compliance")}>
